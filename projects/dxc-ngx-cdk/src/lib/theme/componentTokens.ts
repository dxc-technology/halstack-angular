...
export const componentTokens = {
  ...
  //NEW DATE
  "--newDate-pickerSelectedDateBackgroundColor": globalTokens.hal_purple_s_38,
  ...
  //NEW SELECT
  "--newSelect-fontFamily": globalTokens.type_sans,
  "--newSelect-labelFontSize": globalTokens.type_scale_02,
  "--newSelect-labelFontStyle": globalTokens.type_normal,
  "--newSelect-labelFontWeight": globalTokens.type_semibold,
  "--newSelect-labelLineHeight": globalTokens.type_leading_loose_01,
  "--newSelect-valueFontSize": globalTokens.type_scale_03,
  "--newSelect-valueFontStyle": globalTokens.type_normal,
  "--newSelect-valueFontWeight": globalTokens.type_regular,
  "--newSelect-placeholderFontSize": globalTokens.type_scale_03,
  "--newSelect-placeholderFontStyle": globalTokens.type_normal,
  "--newSelect-placeholderFontWeight": globalTokens.type_regular,
  "--newSelect-helperTextFontSize": globalTokens.type_scale_01,
  "--newSelect-helperTextFontStyle": globalTokens.type_normal,
  "--newSelect-helperTextFontWeight": globalTokens.type_regular,
  "--newSelect-helperTextLineHeight": globalTokens.type_leading_normal,
  "--newSelect-errorMessageFontSize": globalTokens.type_scale_01,
  "--newSelect-errorMessagetFontStyle": globalTokens.type_normal,
  "--newSelect-errorMessageFontWeight": globalTokens.type_regular,
  "--newSelect-errorMessagetLineHeight": globalTokens.type_leading_normal,
  "--newSelect-listItemFontSize": globalTokens.type_scale_02,
  "--newSelect-listItemFontStyle": globalTokens.type_normal,
  "--newSelect-listItemFontWeight": globalTokens.type_regular,
  "--newSelect-listGroupItemFontWeight": globalTokens.type_semibold,
  "--newSelect-labelFontColor": globalTokens.hal_black,
  "--newSelect-valueFontColor": globalTokens.hal_black,
  "--newSelect-helperTextFontColor": globalTokens.hal_black,
  "--newSelect-collapseIndicatorColor": globalTokens.hal_black,
  "--newSelect-errorColor": globalTokens.hal_red_s_41,
  "--newSelect-placeholderFontColor": "#000000b3",
  "--newSelect-disabledColor": globalTokens.hal_grey_l_60,
  "--newSelect-optionListBackgroundColor": globalTokens.hal_white,
  "--newSelect-optionListBorderColor": globalTokens.hal_grey_l_75,
  "--newSelect-listItemFontColor": globalTokens.hal_black,
  "--newSelect-listItemIconColor": globalTokens.hal_black,
  "--newSelect-listItemDividerColor": globalTokens.hal_grey_l_90,
  "--newSelect-unselectedHoverListItemBackgroundColor": globalTokens.hal_grey_l_95,
  "--newSelect-unselectedActiveListItemBackgroundColor": globalTokens.hal_grey_l_90,
  "--newSelect-selectedlistItemBackgroundColor": globalTokens.hal_blue_l_95,
  "--newSelect-selectedHoverListItemBackgroundColor": globalTokens.color_blue_200,
  "--newSelect-selectedActivelistItemBackgroundColor": globalTokens.hal_blue_l_80,
  "--newSelect-selectedListItemIconColor": globalTokens.hal_blue_d_20,
  "--newSelect-optionBorderThickness": "0px",
  "--newSelect-optionBorderStyle": globalTokens.border_solid,
  "--newSelect-optionFontColor": globalTokens.hal_black,
  "--newSelect-optionFontSize": globalTokens.type_scale_root,
  "--newSelect-optionFontStyle": globalTokens.type_normal,
  "--newSelect-optionFontWeight": globalTokens.type_regular,
  "--newSelect-optionIconSpacing": "12px",
  "--newSelect-optionIconColor": globalTokens.hal_black,
  "--newSelect-optionIconSize": "20px",
  "--newSelect-selectedOptionBackgroundColor": globalTokens.lightGrey,
  "--newSelect-hoverOptionBackgroundColor": globalTokens.hal_grey_l_95,
  "--newSelect-optionPaddingBottom": "6px",
  "--newSelect-optionPaddingTop": "6px",
  "--newSelect-optionPaddingLeft": "16px",
  "--newSelect-optionPaddingRight": "16px",
  "--newSelect-optionCheckboxSpacing": "12px",
  "--newSelect-required": globalTokens.hal_red_s_41,
  "--newSelect-focusColor": globalTokens.hal_blue_l_50,
  "--newSelect-scrollBarThumbColor": globalTokens.hal_grey_s_40,
  "--newSelect-scrollBarTrackColor": globalTokens.lightGrey,
  "--newSelect-underlineColor": globalTokens.hal_black,
  "--newSelect-underlineColorOnDark": globalTokens.hal_white,
  "--newSelect-underlineFocusColor": globalTokens.hal_black,
  "--newSelect-underlineFocusColorOnDark": globalTokens.hal_white,
  "--newSelect-underlineThickness": "1px",
  "--newSelect-arrowColor": globalTokens.hal_black,
  "--newSelect-arrowColorOnDark": globalTokens.hal_white,
