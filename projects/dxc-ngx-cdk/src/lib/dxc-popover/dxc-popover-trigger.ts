...
import { DxcPopoverPanel, DxcTarget } from './dxc-popover-interfaces';
import { DxcPopoverPositionX, DxcPopoverPositionY, DxcPopoverTriggerEvent, DxcPopoverScrollStrategy } from './dxc-popover-types';
import { throwDxcPopoverMissingError } from './dxc-popover-errors';
import { takeUntil } from 'rxjs/operators';



/**
 * This directive is intended to be used in conjunction with an dxc-popover tag. It is
...
export class DxcPopoverTrigger implements AfterViewInit, OnDestroy { // tslint:disable-line:directive-class-suffix
    ...
    @Input('dxcPopoverTriggerFor') popover: DxcPopoverPanel;

    /** References the popover target instance that the trigger is associated with. */
    @Input('dxcPopoverTargetAt') targetElement: DxcTarget;

    /** Position of the popover in the X axis */
    @Input('dxcPopoverPositionX') positionX: DxcPopoverPositionX;

    /** Position of the popover in the Y axis */
    @Input('dxcPopoverPositionY') positionY: DxcPopoverPositionY;

    /** Popover trigger event */
    @Input('dxcPopoverTriggerOn') triggerEvent: DxcPopoverTriggerEvent;

    /** Popover delay */
    @Input('dxcPopoverEnterDelay') enterDelay: number;

    /** Popover delay */
    @Input('dxcPopoverLeaveDelay') leaveDelay: number;

    /** Popover overlap trigger */
    @Input('dxcPopoverOverlapTrigger') overlapTrigger: boolean;

    /** Popover target offset x */
    @Input('dxcPopoverOffsetX') targetOffsetX: number;

    /** Popover target offset y */
    @Input('dxcPopoverOffsetY') targetOffsetY: number;

    /** Popover arrow offset x */
    @Input('dxcPopoverArrowOffsetX') arrowOffsetX: number;


    /** Popover arrow width */
    @Input('dxcPopoverArrowWidth') arrowWidth: number;


    /** Popover arrow color */
    @Input('dxcPopoverArrowColor') arrowColor: string;


    /** Popover container close on click */
    @Input('dxcPopoverCloseOnClick') closeOnClick: boolean;


    /** Popover backdrop close on click */
    @Input('dxcPopoverBackdropCloseOnClick') backdropCloseOnClick = true;
    ...
    */
     ...
     */
    private _getOverlayScrollStrategy(strategy: DxcPopoverScrollStrategy): ScrollStrategy {
      switch(strategy) {
        case 'noop':
          console.log('noop');
    ...
    */
    private _subscribeToPositions(position: FlexibleConnectedPositionStrategy): void {
        this._positionSubscription = position.positionChanges.subscribe(change => {
            const posisionX: DxcPopoverPositionX = change.connectionPair.overlayX === 'start' ? 'after' : 'before';
            let posisionY: DxcPopoverPositionY = change.connectionPair.overlayY === 'top' ? 'below' : 'above';
    ...
    */
    private _getPosition(): FlexibleConnectedPositionStrategy {
        ...
        /**
         * For overriding position element, when dxcPopoverTargetAt has a valid element reference.
