...
import { defaultConfig, constructKey, isSerializer } from '../../dxc-localstorage/utils';
...
export class LocalStorageService {
   ...
   */
  constructor(
    @Inject(DXC_LOCAL_STORAGE_SERIALIZER) private readonly defaultSerializer: StorageSerializer,
    @Inject(DXC_LOCAL_STORAGE_CONFIG) public readonly config?: DxcLocalstorageConfiguration
  ) {
