...
export class FileInputComponent implements OnInit {
  ...
  ngOnInit() {
    this.sections.push( 
      {id:0, label: 'API',selector: 'file-input-api', component: FileInputApiComponent},
      {id:1, label: 'EXAMPLES', selector: 'examples-component-file-input', component: FileInputExampleComponent}
      );
  }
