...
import { TextInputMaskedComponent } from '../text-input-masked/text-input-masked.component';
...
export class TextInputExampleComponent implements OnInit {
  ...
  private createExamples() {
    this.exampleService
      ...
      this.exampleService
      .getCodeExample("text-input/text-input-masked/text-input-masked.component").subscribe(resp1 => {
        this.examples.push(this.exampleService.generateExample({
          title: 'Masked Input',
          component: TextInputMaskedComponent,
