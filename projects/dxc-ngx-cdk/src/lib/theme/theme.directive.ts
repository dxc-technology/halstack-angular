...
export class ThemeDirective implements OnInit, OnDestroy {
  ...
  setPropertiesCss(theme: Theme){
    let obj = {
      ...
      "--inputText-color": theme.properties["inputText"]["color"],
      "--inputText-placeholderColor": theme.properties["inputText"]["placeholderColor"],
      "--inputText-disabledFontColor": theme.properties["inputText"]["disabledFontColor"],
      "--inputText-disabledLabelColor": theme.properties["inputText"]["disabledLabelColor"],
      "--inputText-disabledUnderlinedColor": theme.properties["inputText"]["disabledUnderlinedColor"],
      "--inputText-disabledAssistiveTextColor": theme.properties["inputText"]["disabledAssistiveTextColor"],
