...
export class ThemeDirective implements OnInit, OnDestroy {
  ...
  setPropertiesCss(theme: Theme){
    let obj = {
      ...
      "--tabs-selectedIconColor": theme.properties["tabs"]["selectedFontColor"],
      "--tabs-selectedUnderlinedColor": theme.properties["tabs"]["selectedFontColor"],
      "--tabs-divider": theme.properties["tabs"]["fontColor"] + theme.properties["tabs"]["divider"],
      "--tabs-disabledFontColor": theme.properties["tabs"]["fontColor"] + theme.properties["tabs"]["disabledFontColor"],
      "--tabs-backgroundColor": theme.properties["tabs"]["backgroundColor"],
      "--tabs-fontColor": theme.properties["tabs"]["fontColor"],
      "--tabs-focusColor": theme.properties["tabs"]["selectedFontColor"],
      "--tabs-hoverBackgroundColor": theme.properties["tabs"]["selectedFontColor"] + theme.properties["tabs"]["hoverBackgroundColor"],
      "--tabs-pressedBackgroundColor": theme.properties["tabs"]["selectedFontColor"] + theme.properties["tabs"]["pressedBackgroundColor"],
      ...
      "--accordion-disabledFontColor": theme.properties["accordion"]["fontColor"] + theme.properties["accordion"]["disabledFontColor"],
      "--accordion-focusOutline": theme.properties["accordion"]["arrowColor"],
