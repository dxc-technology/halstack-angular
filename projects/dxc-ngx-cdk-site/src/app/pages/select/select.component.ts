...
export class SelectComponent implements OnInit {
  ...
  ngOnInit() {
    this.sections.push( 
      {id:0, label: 'API',selector: 'select-api', component: SelectApiComponent},
      {id:1, label: 'EXAMPLES', selector: 'examples-component-select', component: SelectExampleComponent}
      );
  }
