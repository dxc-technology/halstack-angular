...
import { throwDxcPopoverInvalidPositionX, throwDxcPopoverInvalidPositionY } from './dxc-popover-errors';
import { DxcPopoverPanel } from './dxc-popover-interfaces';
...
export class DxcPopover implements DxcPopoverPanel, OnDestroy { // tslint:disable-line:component-class-suffix
  ...
  private _positionX: DxcPopoverPositionX = 'after';
  private _positionY: DxcPopoverPositionY = 'below';
  private _triggerEvent: DxcPopoverTriggerEvent = 'hover';
  private _scrollStrategy: DxcPopoverScrollStrategy = 'reposition';
  ...
  @Input('dxcPopoverPositionX')
  get positionX() { return this._positionX; }
  set positionX(value: DxcPopoverPositionX) {
    if (value !== 'before' && value !== 'after') {
      throwDxcPopoverInvalidPositionX();
    }
  ...
  @Input('dxcPopoverPositionY')
  get positionY() { return this._positionY; }
  set positionY(value: DxcPopoverPositionY) {
    if (value !== 'above' && value !== 'below') {
      throwDxcPopoverInvalidPositionY();
    }
   ...
   * default: false
   */
  @Input('dxcPopoverDisableAnimation')
   ...
   * default: true
   */
  @Input('dxcFocusTrapAutoCaptureEnabled')
  ...
  setPositionClasses(posX = this.positionX, posY = this.positionY): void {
    this._classList['dxc-popover-before'] = posX === 'before';
    this._classList['dxc-popover-after'] = posX === 'after';
    this._classList['dxc-popover-above'] = posY === 'above';
    this._classList['dxc-popover-below'] = posY === 'below';
  }
}
