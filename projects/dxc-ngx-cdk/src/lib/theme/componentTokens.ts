...
export const componentTokens = {
  ...
  "--button-paddingRight": "0.5rem",
  "--button-paddingTop": "0.5rem",
  "--button-paddingBottom": "0.5rem",
  ...
  "--newInputText-labelLineHeight": "1.715em",
  ...
  "--newInputText-helperTextLineHeight": "1.5em",
  ...
  "--newTextarea-labelLineHeight": "1.715em",
  ...
  "--newTextarea-helperTextLineHeight": "1.5em",
  ...
  //TOGGLE GROUP
  "--toggleGroup-containerBackgroundColor": "#fafafa",
  ...
  "--toggleGroup-labelFontSize": "0.875rem",
  "--toggleGroup-labelFontStyle": globalTokens.type_normal,
  "--toggleGroup-labelFontWeight": globalTokens.type_regular,
  "--toggleGroup-labelLineHeight": "1.75em",
  ...
  "--toggleGroup-helperTextLineHeight": globalTokens.type_scale_05,

  "--toggleGroup-optionLabelFontFamily": globalTokens.type_sans,
  "--toggleGroup-optionLabelFontSize": "1rem",
  "--toggleGroup-optionLabelFontStyle": "normal",
  "--toggleGroup-optionLabelFontWeight": "400",
  "--toggleGroup-iconPaddingRight": "0.5rem",
  "--toggleGroup-iconPaddingLeft": "0.5rem",
  "--toggleGroup-labelPaddingLeft": "1.5rem",
  "--toggleGroup-labelPaddingRight": "1.5rem",
  "--toggleGroup-iconMarginRight": "0.5rem",
  "--toggleGroup-containerMarginTop": "0.25rem",
  "--toggleGroup-optionBorderThickness": "0px",
  "--toggleGroup-optionBorderStyle": "none",
  "--toggleGroup-optionBorderRadius": "4px",
  "--toggleGroup-containerBorderThickness": "1px",
  "--toggleGroup-containerBorderStyle": "solid",
  "--toggleGroup-containerBorderRadius": "6px",
  "--toggleGroup-optionFocusBorderThickness": "2px",
  "--toggleGroup-optionFocusBorderStyle":  "solid",
  "--toggleGroup-optionFocusBorderRadius": "4px",
   //UPLOAD
