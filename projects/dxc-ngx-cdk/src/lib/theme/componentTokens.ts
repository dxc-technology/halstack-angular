...
export const componentTokens = {
  ...
  "--button-primaryFontColorOnDark": globalTokens.black,
  "--button-primaryHoverFontColor": globalTokens.white,
  "--button-primaryHoverFontColorOnDark": globalTokens.black,
  ...
  "--button-primaryDisabledFontColorOnDark": globalTokens.black,
  ...
  "--button-secondaryFontColorOnDark": globalTokens.white,
  "--button-secondaryHoverFontColor": globalTokens.black,
  "--button-secondaryHoverFontColorOnDark": globalTokens.white,
  ...
  "--button-textFontColorOnDark": globalTokens.white,
  "--button-textHoverFontColor": globalTokens.white,
  "--button-textHoverFontColorOnDark": globalTokens.white,
  ...
  "--dropdown-buttonBackgroundColor": globalTokens.white,
  "--dropdown-buttonFontColor": globalTokens.black,
  "--dropdown-buttonHoverBackgroundColor": globalTokens.lightWhite,
  ...
  "--dropdown-optionsListBackgroundColor": globalTokens.white,
  "--dropdown-optionsListHoverBackgroundColor": globalTokens.lightWhite,
  ...
  "--dropdown-optionsFontColor": globalTokens.black,
  ...
  "--dropdown-iconColor": globalTokens.black,
  ...
  "--header-fontColorBase": globalTokens.black,
  ...
  "--header-hamburguerFontSize": globalTokens.fontSize10,
  ...
  "--header-menuBackgroundColor": globalTokens.white,
  ...
  "--inputText-assistiveTextFontColorOnDark": globalTokens.white,
  ...
  "--inputText-errorColor": globalTokens.darkRed,
  "--inputText-errorColorOnDark": "#FE344F",
  "--inputText-fontColorBase": globalTokens.black,
  "--inputText-fontColorBaseOnDark": globalTokens.white,
  ...
  "--inputText-prefixIconColor": globalTokens.black,
  "--inputText-prefixIconColorOnDark": globalTokens.white,
  "--inputText-prefixLabelFontColor": globalTokens.black,
  "--inputText-prefixLabelFontColorOnDark": globalTokens.white,
  ...
  "--inputText-suffixIconColor": globalTokens.black,
  "--inputText-suffixIconColorOnDark": globalTokens.white,
  "--inputText-suffixLabelFontColor": globalTokens.black,
  "--inputText-suffixLabelFontColorOnDark": globalTokens.white,
  ...
  "--inputText-underlineColor": globalTokens.black,
  "--inputText-underlineColorOnDark": globalTokens.white,
  ...
  //SPINNER
  "--spinner-trackCircleColor": "#5f249f",
  ...
  "--spinner-labelFontColor": globalTokens.black,
  ...
  "--spinner-progressValueFontColor": globalTokens.black,
  ...
  "--spinner-overlayTrackCircleColor": "#a46ede",
  ...
  "--textarea-errorColor": globalTokens.darkRed,
  "--textarea-errorColorOnDark": "#FE344F",
  ...
  "--textarea-assistiveTextFontColor": globalTokens.black,
  "--textarea-assistiveTextFontColorOnDark": globalTokens.white,
  ...
  "--textarea-customContentFontColor": globalTokens.black,
  "--textarea-customContentFontColorOnDark": globalTokens.white,
  ...
  "--textarea-labelFontColor": globalTokens.black,
  "--textarea-labelFontColorOnDark": globalTokens.white,
  "--textarea-labelLetterSpacing": globalTokens.type_spacing_normal,
  "--textarea-scrollBarThumbColor": globalTokens.darkGrey,
  "--textarea-scrollBarThumbColorOnDark": globalTokens.white,
  "--textarea-scrollBarTrackColor": globalTokens.lightGrey,
  "--textarea-scrollBarTrackColorOnDark": "#999999",
