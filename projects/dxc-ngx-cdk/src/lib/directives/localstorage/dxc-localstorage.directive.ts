...
import { getProperty, setProperty } from '../../dxc-localstorage/utils';
 ...
 */
@Directive({
  selector: '[dxcLocalStorage]'
})
export class DxcLocalStorageDirective implements AfterViewInit, OnDestroy {

  /**
   * The key to use with localstorage.
   */
  @Input('dxcLocalStorage')
  public lsKey: string;
  /**
