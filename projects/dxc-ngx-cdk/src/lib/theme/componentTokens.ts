...
export const componentTokens = {
  ...
  "--heading-level1FontSize": globalTokens.type_scale_07,
  "--heading-level1FontStyle": globalTokens.type_normal,
  "--heading-level1FontWeight": globalTokens.type_semibold,
  ...
  "--heading-level2FontSize": globalTokens.type_scale_05,
  "--heading-level2FontStyle": globalTokens.type_normal,
  "--heading-level2FontWeight": globalTokens.type_semibold,
  ...
  "--heading-level3FontSize": globalTokens.type_scale_04,
  "--heading-level3FontStyle": globalTokens.type_semibold,
  ...
  "--heading-level4FontSize": globalTokens.type_scale_03,
  "--heading-level4FontStyle": globalTokens.type_normal,
  "--heading-level4FontWeight": globalTokens.type_semibold,
  ...
  "--heading-level5FontSize": globalTokens.type_scale_02,
  "--heading-level5FontStyle": globalTokens.type_normal,
  "--heading-level5FontWeight": globalTokens.type_semibold,
  ...
  //RADIO GROUP
  "--radioGroup-radioInputColor": globalTokens.hal_blue_l_45,
  "--radioGroup-hoverRadioInputColor": globalTokens.hal_blue_s_35,
  "--radioGroup-focusRadioInputColor": globalTokens.hal_blue_l_50,
  "--radioGroup-activeRadioInputColor": globalTokens.hal_blue_d_20,
  "--radioGroup-errorRadioInputColor": globalTokens.hal_red_s_41,
  "--radioGroup-hoverErrorRadioInputColor": globalTokens.hal_red_d_30,
  "--radioGroup-activeErrorRadioInputColor": globalTokens.hal_red_d_20,
  "--radioGroup-disabledRadioInputColor": globalTokens.hal_grey_l_60,
  "--radioGroup-readonlyRadioInputColor": globalTokens.hal_grey_l_60,
  "--radioGroup-hoverReadonlyRadioInputColor": globalTokens.color_grey_600,
  "--radioGroup-activeReadonlyRadioInputColor": globalTokens.hal_grey_s_40,
  "--radioGroup-labelFontColor": globalTokens.hal_black,
  "--radioGroup-disabledLabelFontColor": globalTokens.hal_grey_l_60,
  "--radioGroup-helperTextFontColor": globalTokens.hal_black,
  "--radioGroup-disabledHelperTextFontColor": globalTokens.hal_grey_l_60,
  "--radioGroup-radioInputLabelFontColor": globalTokens.hal_black,
  "--radioGroup-disabledRadioInputLabelFontColor": globalTokens.hal_grey_l_60,
  "--radioGroup-errorMessageColor": globalTokens.hal_red_s_41,

  "--radioGroup-labelFontFamily": globalTokens.type_sans,
  "--radioGroup-labelFontSize": globalTokens.type_scale_02,
  "--radioGroup-labelFontWeight": globalTokens.type_semibold,
  "--radioGroup-labelLineHeight": globalTokens.type_leading_loose_01,
  "--radioGroup-labelFontStyle": globalTokens.type_normal,
  "--radioGroup-helperTextFontFamily": globalTokens.type_sans,
  "--radioGroup-helperTextFontSize": globalTokens.type_scale_01,
  "--radioGroup-helperTextFontWeight": globalTokens.type_regular,
  "--radioGroup-helperTextFontStyle": globalTokens.hal_grey_l_60,
  "--radioGroup-helperTextLineHeight": globalTokens.type_leading_normal,
  "--radioGroup-radioInputLabelFontFamily": globalTokens.type_sans,
  "--radioGroup-radioInputLabelFontSize": globalTokens.type_scale_02,
  "--radioGroup-radioInputLabelFontWeight": globalTokens.type_regular,
  "--radioGroup-radioInputLabelFontStyle": globalTokens.type_normal,
  "--radioGroup-errorMessageFontSize": globalTokens.type_scale_01,
  "--radioGroup-errorMessageFontWeight": globalTokens.type_regular,
  "--radioGroup-errorMessageLineHeight": globalTokens.type_leading_normal,

  "--radioGroup-radioInputBorderWidth": globalTokens.border_width_2,
  "--radioGroup-radioInputBorderStyle": globalTokens.border_solid,
  "--radioGroup-focusBorderWidth": globalTokens.border_width_2,
  "--radioGroup-focusBorderStyle": globalTokens.border_solid,

  "--radioGroup-groupLabelMargin": globalTokens.spacing_03,
  "--radioGroup-radioInputLabelMargin": globalTokens.spacing_03,
  "--radioGroup-groupVerticalGutter": globalTokens.spacing_02,
  "--radioGroup-groupHorizontalGutter": globalTokens.spacing_07,

  // "--radioGroup-radioInputwidth": "18px",
