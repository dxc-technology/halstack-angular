...
@NgModule({
  declarations: [ComponentsSidenavComponent, ComponentsSidenavMenuComponent],
  imports: [
    BrowserModule,
    CommonModule,
    RouterModule,
  ...
  exports: [ComponentsSidenavComponent, ComponentsSidenavMenuComponent],
  entryComponents: [DxcSidenavComponent],
})
