...
export class ThemeDirective implements OnInit, OnDestroy {
  ...
  setPropertiesCss(theme: Theme){
    let obj = {
      ...
      "--button-primaryActiveOpacity": theme.properties["button"]["primaryActiveOpacity"],
      "--button-secondaryDisabledOpacity": theme.properties["button"]["secondaryDisabledOpacity"],
      "--button-secondaryActiveOpacity": theme.properties["button"]["secondaryActiveOpacity"],
      ...
      "--button-textActiveOpacity": theme.properties["button"]["textActiveOpacity"],
      ...
      "--header-hoverHamburguerColor": theme.properties["header"]["hoverHamburguerColor"],
      ...
      "--wizard-selectedBackgroundFont": theme.properties["wizard"]["selectedBackgroundFont"],
