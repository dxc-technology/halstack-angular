...
export const componentTokens = {
  ...
  // NEW INPUT TEXT
  "--input-outlineDisabledColor": globalTokens.hal_grey_l_60,
  "--input-outlineDisabledColorOnDark": globalTokens.hal_grey_l_60,
  ...
  "--input-disabledLabelColor": globalTokens.hal_grey_l_60,
  "--input-disabledLabelColorOnDark": globalTokens.hal_grey_l_60,
  "--input-disabledSuffixColor": globalTokens.hal_grey_l_60,
  "--input-disabledSuffixColorOnDark": globalTokens.hal_grey_l_60,
  "--input-disabledPrefixColor": globalTokens.hal_grey_l_60,
  "--input-disabledPrefixColorOnDark": globalTokens.hal_grey_l_60,
  "--input-disabledActionColor": globalTokens.hal_grey_l_60,
  "--input-disabledActionColorOnDark": globalTokens.hal_grey_l_60,
  ...
  "--input-hoverOutlineColor": globalTokens.hal_purple_l_65,
  "--input-hoverOutlineColorOnDark": globalTokens.hal_purple_l_65,
  "--input-focusOutlineColor": globalTokens.hal_purple_l_65,
  "--input-focusOutlineColorOnDark": globalTokens.hal_purple_l_65,
  "--input-outlineEnabledColor": globalTokens.hal_black,
  "--input-outlineEnabledColorOnDark": globalTokens.hal_white,
  "--input-placeholderColor": globalTokens.hal_grey_s_40,
  "--input-placeholderColorOnDark": globalTokens.hal_grey_l_95,
  "--input-inputTextFontColor": globalTokens.hal_black,
  "--input-inputTextFontColorOnDark": globalTokens.hal_white,
  "--input-inputTextFontSize": globalTokens.type_scale_03,
  "--input-inputTextFontStyle": globalTokens.type_normal,
  "--input-inputTextFontWeight": globalTokens.type_regular,
  "--input-hoverActionBackgroundColor": globalTokens.hal_grey_l_95,
  "--input-focusActionBackgroundColor": globalTokens.hal_grey_l_95,
  "--input-activeActionBackgroundColor": globalTokens.hal_grey_l_80,
  "--input-hoverActionBackgroundColorOnDark": globalTokens.hal_grey_l_95,
  "--input-focusActionBackgroundColorOnDark": globalTokens.hal_purple_l_65,
  "--input-activeActionBackgroundColorOnDark": globalTokens.hal_grey_l_60,
  "--input-prefixLabelColor": globalTokens.hal_grey_s_40,
  "--input-prefixLabelColorOnDark": globalTokens.hal_white,
  ...
  "--input-suffixLabelColor": globalTokens.hal_grey_s_40,
  "--input-suffixLabelColorOnDark": globalTokens.hal_white,
  ...
  "--input-errorOutlineColor": globalTokens.hal_red_s_41,
  "--input-errorOutlineColorOnDark": globalTokens.hal_red_l_60,
  ...
  "--slider-thumbBackgroundColorOnDark": globalTokens.hal_white,
  "--slider-draggedThumbScale": "1",
  "--slider-draggedThumbBackgroundColor": globalTokens.hal_blue_s_35,
  "--slider-draggedThumbBackgroundColorOnDark": globalTokens.hal_blue_l_50,
  "--slider-dotsSize": "6px",
  "--slider-dotsVerticalPosition": "-1px",
  "--slider-dotsBackgroundColor": globalTokens.hal_blue_s_35,
  "--slider-dotsBackgroundColorOnDark": globalTokens.hal_white,
  "--slider-lineThickness": "2px",
  "--slider-lineVerticalPosition": "0px",
  "--slider-trackLineColor": globalTokens.hal_blue_s_35,
  "--slider-trackLineOnDark": globalTokens.hal_white,
  "--slider-totalLineColor": globalTokens.softBlue,
  "--slider-totalLineOnDark": globalTokens.hal_white,
